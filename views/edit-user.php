        ...
        <div class="row justify-content-center mb-3">
            <div class="col-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="first_name" id="first_name" class="form-control" value="<?= user['first_name']?>" reuqired autofocus>
                </div>
    

                <div class="mb-3">
                    <label for="last_name" class="form-label">Last Name</label>
                    <input type="text" name="last_name" id="last_name" class="form-control" value="<?= user['last_name']?>" reuqired>
                </div>
